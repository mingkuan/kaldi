...
# local/chain/tuning/run_tdnn_lstm_bs_1a.sh --mic sdm1 --use-ihm-ali true --train-set train_cleaned  --gmm tri3_cleaned
# local/chain/compare_wer_general.sh sdm1 tdnn_lstm_bs_1a_sp_bi_ihmali_ld5 tdnn_lstm1o_sp_bi_ihmali_ld5

# System        tdnn_lstm_bs_1a_sp_bi_ihmali_ld5 tdnn_lstm1o_sp_bi_ihmali_ld5
# WER on dev        33.8      35.2
# WER on eval        37.5      38.7
# Final train prob      -0.126056 -0.167549
# Final valid prob      -0.228452  -0.24847
# Final train prob (xent)      -1.51685   -1.7403
# Final valid prob (xent)      -2.04719  -2.13732
...
if $use_ihm_ali; then
  ...
  dir=exp/$mic/chain${nnet3_affix}/tdnn_lstm_bs_${tlstm_affix}_sp_bi_ihmali
  ...
  dir=exp/$mic/chain${nnet3_affix}/tdnn_lstm_bs_${tlstm_affix}_sp_bi
fi
...
if [ $stage -le 16 ]; then
  ...
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --trainer.optimization.max-models-combine=30 \
