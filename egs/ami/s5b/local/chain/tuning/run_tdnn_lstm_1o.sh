...
# changed to fast-lstmp layer
# changed num-chunk-per-minibatch to be variable
# added extra_left_context_initial=0
# and extra_right_context_final=0
# The results match those from 1n.

# local/chain/tuning/run_tdnn_lstm_1o.sh --mic sdm1 --use-ihm-ali true --train-set train_cleaned  --gmm tri3_cleaned
# local/chain/compare_wer_general.sh sdm1 tdnn_lstm1n_sp_bi_ihmali_ld5 tdnn_lstm1o_sp_bi_ihmali_ld5
# System               tdnn_lstm1n_sp_bi_ihmali_ld5 tdnn_lstm1o_sp_bi_ihmali_ld5
# WER on dev        35.2      35.0
# WER on eval        38.3      38.5
# Final train prob       -0.16497 -0.161843
# Final valid prob      -0.246395 -0.246126
# Final train prob (xent)      -1.73635  -1.72218
# Final valid prob (xent)      -2.13462  -2.12589
...
tlstm_affix=1o  #affix for TDNN-LSTM directory, e.g. "a" or "b", in case we change the configuration.
