...
# WER on dev        36.1      34.1
# WER on eval        39.1      37.8
# Final train prob      -0.130943 -0.144104
# Final valid prob      -0.243206 -0.222104
# Final train prob (xent)      -1.57159  -1.63347
# Final valid prob (xent)      -2.09093    -2.041
...
tgru_affix=1b  #affix for TDNN-NormOPGRU directory, e.g. "a" or "b", in case we change the configuration.
