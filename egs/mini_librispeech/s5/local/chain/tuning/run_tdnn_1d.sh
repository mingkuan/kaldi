...
# local/chain/compare_wer.sh --online exp/chain/tdnn1c_sp exp/chain/tdnn1d_sp
# System                tdnn1c_sp tdnn1d_sp
#WER dev_clean_2 (tgsmall)      14.69     13.94
#             [online:]         14.63     13.98
#WER dev_clean_2 (tglarge)      10.45      9.94
#             [online:]         10.56     10.00
# Final train prob        -0.0463   -0.0479
# Final valid prob        -0.0896   -0.0880
# Final train prob (xent)   -1.0632   -1.0837
# Final valid prob (xent)   -1.4584   -1.4465


# steps/info/chain_dir_info.pl exp/chain/tdnn1{c,d}_sp
