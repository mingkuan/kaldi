...
# local/chain/compare_wer.sh --online exp/chain/tdnn1b_sp exp/chain/tdnn1c_sp
# System                tdnn1b_sp tdnn1c_sp
#WER dev_clean_2 (tgsmall)      14.87     14.69
#             [online:]         14.99     14.63
#WER dev_clean_2 (tglarge)      10.86     10.45
#             [online:]         10.79     10.56
# Final train prob        -0.0609   -0.0463
# Final valid prob        -0.0956   -0.0896
# Final train prob (xent)   -1.3493   -1.0632
# Final valid prob (xent)   -1.6350   -1.4584


# steps/info/chain_dir_info.pl exp/chain/tdnn1{b,c}_sp
# exp/chain/tdnn1b_sp: num-iters=17 nj=2..5 num-params=7.0M dim=40+100->2353 combine=-0.088->-0.064 xent:train/valid[10,16,final]=(-2.32,-1.61,-1.35/-2.49,-1.86,-1.63) logprob:train/valid[10,16,final]=(-0.164,-0.079,-0.061/-0.196,-0.117,-0.096)
