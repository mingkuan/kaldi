...
modelDir=../../../egs/cvte/s5
wavFile=${modelDir}/data/wav/00030/2017_03_07_16.57.22_1175.wav
#wavFile=${modelDir}/data/wav/00030/2017_03_07_16.58.47_5561.wav

#../../../egs/cvte/s5/data/wav/00030/2017_03_07_16.57.22_1175.wav
#../../../egs/cvte/s5/data/wav/00030/2017_03_07_16.58.47_5561.wav

online2-wav-nnet3-latgen-faster --do-endpointing=false --online=false --feature-type=fbank --fbank-config=${modelDir}/conf/fbank.conf --max-active=7000 --beam=15.0 --lattice-beam=6.0 --acoustic-scale=1.0 --word-symbol-table=${modelDir}/exp/chain/tdnn/graph/words.txt ${modelDir}/exp/chain/tdnn/final.mdl ${modelDir}/exp/chain/tdnn/graph/HCLG.fst 'ark:echo utter1 utter1|' 'scp:echo utter1 ../../../egs/cvte/s5/data/wav/00030/2017_03_07_16.58.47_5561.wav|' ark:/dev/null
